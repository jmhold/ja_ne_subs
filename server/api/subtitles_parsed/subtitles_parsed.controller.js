...
var SubtitlesParsed = require('./subtitles_parsed.model');

// Get list of subtitles_parseds
exports.index = function(req, res) {
  SubtitlesParsed.find(function (err, subtitles_parseds) {
...
exports.show = function(req, res) {
  SubtitlesParsed.findById(req.params.id, function (err, subtitles_parsed) {
    if(err) { return handleError(res, err); }
...
exports.create = function(req, res) {
  SubtitlesParsed.create(req.body, function(err, subtitles_parsed) {
    if(err) { return handleError(res, err); }
